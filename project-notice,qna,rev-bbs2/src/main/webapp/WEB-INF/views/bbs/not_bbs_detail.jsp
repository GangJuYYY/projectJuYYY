					...
					<div id="view-menu">
						<div>
							<input type="button" value="수정" onclick="goModify();" style="margin-left: 250px" class="btn btn-info btn-sm active" /> <input
								type="button" value="삭제" onclick="goDelete()" style="margin-left: 0px" class="btn btn-info btn-sm active" />
			
							<input type="button" value="목록" onclick="goList()" style="margin-left: 0px" class="btn btn-info btn-sm active" /> 
						</div>
					</div>
