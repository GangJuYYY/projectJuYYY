				...
				<div id="bbs">
				  <h3>DETAIL</h3>
				   <hr class="line">
					...
					<div id="view-menu">
						<div class="fl">
							<input type="button" value="수정" onclick="goModify();" style="margin-left: 270px" class="btn btn-info btn-sm active" /> <input
								type="button" value="삭제" onclick="goDelete()" style="margin-left: 20px" class="btn btn-info btn-sm active" />
						</div>
						<div class="fr">
							<input type="button" value="목록" onclick="goList()" style="margin-left: 270px" class="btn btn-info btn-sm active" /> <input
								type="button" value="새글쓰기" onclick="goWrite()" style="margin-left: 20px" class="btn btn-info btn-sm active" />
						</div>
					</div>
