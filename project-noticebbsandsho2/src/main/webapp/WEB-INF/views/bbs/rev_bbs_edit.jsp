...
<tr>
    <td>TITLE</td>
    <td><input type="text" name="title" size="71" value="${thisBbsVo.title }" /></td>
</tr>
<tr>
    <td>CONTENT</td>
        <td colspan="2"><textarea name="contents" rows="20" style="width: 580px">${thisBbsVo.contents }</textarea>
    </td>
</tr>
...
<div style="text-align: center;padding-bottom: 15px; padding-right: 397px;">
    ...
    <input type="button" value="상세보기" onclick="goView()" class="btn btn-info btn-sm active" />
