...
<!-- <p align="center">footer test</p> -->
    <div class="footer01">
      <div class="col-md-4">
          <h4>CS CENTER</h4>
          <h5>1320-3543<h5><br/>
          <a>Weekday. am10:00 - pm17:00<br>Closed. Sat. Sun. Holiday</a>
          <br/>
          <br/>
          <br/>
          <br/>
        ...
        <div class="col-md-2">
          <h4>BANKING</h4>
          <h6>국민 142423-52-131424<br>우리 2402-424-224244<br>신한 142-535-242424<br><br>예금주:씨엘로</h6>
        </div>
        <div class="col-md-4">
           <h4>ADDRESS</h4>
           <h6>비트시 뭐하구 릴리동2가 221-4241번지 주소주소주소<br><br>(교환/반품 주소)<br>파주 리얼로40 주소주소주소<br><br>(방문수령 및 타택배 반품시)<br>비트시 주소주소</h6>
      </div>
     </div>
</body>
</html>