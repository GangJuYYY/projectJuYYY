...
<br />
	<div id="search" style="text-align: center; margin-left: 1065px;">
		<form id="searchForm" action="/shop01/shoacc3/" method="get"
				...
				<tbody>
					<c:forEach items="${list }" var="productsVo" varStatus="status">
						<tr>
							...
							<td align="right" style="text-align: right; width: 400px;"><img src="../resources/imgs2/${productsVo.product_url }" style="width: 200px;"/></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
