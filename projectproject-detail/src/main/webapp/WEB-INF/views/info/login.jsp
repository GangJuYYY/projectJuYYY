...
<form class="form-horizontal" action="/shop01/login/" method="POST" onsubmit="return login()">
  <fieldset>
    <div id="legend">
    ...
    <div class="control-group">
      <!-- Button -->
      <div class="controls">
        <button class="btn btn-info btn-sm active" style="width: 288px" type="submit">LOGIN</button>
        <br/>
        <br/>
      </div>
    </div>
       ...
       <button class="btn btn-info btn-sm active" style="width: 288px" type="button"  onclick="location.href='/shop01/join/'">JOIN</button>
</div>
