...
<%-- 	<a href="edit.bit?idx=${bean.bbsNum  }" role="btn" class="btn btn-info btn-sm active">EDIT</a> --%>
<%-- 	<a href="delete.bit?idx=${bean.bbsNum  }" role="btn" class="btn btn-info btn-sm active">DELETE</a> --%>
<!-- </div> -->
<!-- </div> -->
<!-- </div> -->
